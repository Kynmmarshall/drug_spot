...
class _RegistrationScreenState extends State<RegistrationScreen> {
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 24),
                    // ── Geolocation (pharmacy only) ──────────────
                    if (_selectedType == UserType.pharmacy)
                      Container(
  ...
  Future<void> _handleSubmit() async {
    ...
    final result = await context.appState.register(
      username: _usernameController.text.trim(),
      email: _emailController.text.trim(),
      phone: _phoneController.text.trim(),
      password: _passwordController.text,
      userType: _selectedType == UserType.pharmacy ? 'pharmacy' : 'patient',
    );
    ...
    // Go straight to the dashboard after successful registration
    final destination = _selectedType == UserType.pharmacy
