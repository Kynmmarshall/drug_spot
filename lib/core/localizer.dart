...
class Localizer {
  ...
  static const Map<AppLanguage, Map<String, String>> _values = {
    AppLanguage.en: {
      ...
      'notif_subtitle_short': 'Manage alerts',
      'notif_messages': 'New messages',
      'notif_messages_sub': 'When someone sends you a chat message.',
      'notif_requests': 'Request updates',
      'notif_requests_sub': 'When a medicine request status changes.',
      'notif_medicine': 'New medicines',
      'notif_medicine_sub': 'When a pharmacy near you adds a medicine.',
      'reg_pharmacy_info_section': 'Pharmacy information',
      'reg_credentials_section': 'Account credentials',
      'reg_login_username': 'Login username',
      'reg_login_username_hint': 'Used to sign in to the app',
      'reg_location_required': 'Please detect your pharmacy location first.',
      'medicine_description': 'Short description',
      'med_add_image': 'Tap to add a photo',
      'medicine_details_description': 'Description',
    },
    AppLanguage.fr: {
      ...
      'notif_title': 'Notifications',
      'notif_subtitle': 'Choisissez les notifications à recevoir.',
      'notif_subtitle_short': 'Gérer les alertes',
      'notif_messages': 'Nouveaux messages',
      'notif_messages_sub': 'Quand quelqu\'un vous envoie un message.',
      'notif_requests': 'Mises à jour de demandes',
      'notif_requests_sub': 'Quand le statut d\'une demande change.',
      'notif_medicine': 'Nouveaux médicaments',
      'notif_medicine_sub': 'Quand une pharmacie proche ajoute un médicament.',
      'reg_pharmacy_info_section': 'Informations de la pharmacie',
      'reg_credentials_section': 'Identifiants du compte',
      'reg_login_username': 'Identifiant de connexion',
      'reg_login_username_hint': 'Utilisé pour se connecter',
      'reg_location_required': 'Veuillez détecter la position de votre pharmacie.',
      'medicine_description': 'Courte description',
      'med_add_image': 'Appuyer pour ajouter une photo',
      'medicine_details_description': 'Description',
    },
  };
